...
VALUES ('코스트코 견과류 믹스 3kg', '식품', '신선한 견과류입니다.', 30000, 3, '500g씩', 1440, NOW() + INTERVAL 1 DAY, '강남역 3번 출구', NOW() + INTERVAL 2 DAY, 1, '호스트1', 'RECRUITING', 2, NOW(), NOW(), 'system', 'system');
...
VALUES (1, 1, '호스트1', 'HOST', 'JOINED', NOW(), NOW(), NOW(), 'system', 'system'),
       (1, 2, '테스트1', 'MEMBER', 'JOINED', NOW(), NOW(), NOW(), 'system', 'system');
