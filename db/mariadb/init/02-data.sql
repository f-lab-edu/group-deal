...
VALUES ('코스트코 견과류 믹스 3kg', '식품', '신선한 견과류입니다.', 30000, 12, '500g씩', 1440, NOW() + INTERVAL 1 DAY, '강남역 3번 출구', NOW() + INTERVAL 2 DAY, 1, '호스트1', 'RECRUITING', 2, NOW(), NOW(), 'system', 'system');
...
VALUES (1, 1, '호스트1', 'HOST', 'JOINED', 1, NOW(), NOW(), NOW(), 'system', 'system'),
       (1, 2, '멤버1', 'MEMBER', 'JOINED', 2, NOW(), NOW(), NOW(), 'system', 'system');
